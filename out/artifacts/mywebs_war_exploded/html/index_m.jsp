  ...
  <div class="top1">
    <div class="main">
      <ul class="menu">
        ...
        <li><a class="dbt" href="/salary/" title="薪资计算">薪资计算</a></li><li><a class="dbt" href="/html/manager.jsp" title="智能档案">智能档案</a></li><li><a class="dbt" href="/attendance/" title="考勤排班">考勤排班</a></li><li><a class="dbt" href="/html/download.jsp" title="">下载</a></li>
        <li>
    ...
    <div class="f1">
      <div class="cd_f">
        <ul class="cd_f2">
          ...
          <a href="/salary/" class="dbt" style="color: #ffffff;">后台管理</a>
          <p>

          </p>
        </li><li>
          <a href="/html/manager.jsp" class="dbt" style="color: #ffffff;">智能档案</a>
          <p>
          ...
          <a href="/html/upload.html" class="dbt" style="color: #ffffff;">上传</a>
          <p>
          ...
          <p>
            <a href='/function/renshiguanli/'>人事管理</a><br/><a href='/html/manager.jsp'>智能档案</a><br/><a href=''>考勤排班</a><br/><a href='/cmsmanger/plus/list.php?tid=17'>薪资计算</a><br/><a href='/function/zhaopinguanli/'>招聘管理</a><br/><a href='/function/jixiaoguanli/'>绩效管理</a><br/><a href='/function/yidongbangong/'>移动办公</a><br/><a href='/function/yuangongzizhuAPP/'>员工自助APP</a><br/>
          </p>
        </li><li>
