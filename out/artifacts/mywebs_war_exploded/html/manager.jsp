...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body" style="background: url(../images/hh.jpg);background-repeat: no-repeat;background-size: 100%,100%">
    <!-- 内容主体区域 -->
    <div style="padding: 15px; width: 400px;margin: auto;font-size: 20px;">欢迎管理员${sessionScope.username}登录人事管理系统<img src=""></div>
  </div>
